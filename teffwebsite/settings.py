"""
Django settings for teffwebsite project.
...
SECRET_KEY = 'pd44h2zgxilb16))g5om&gai$3^z=-f-)q3yq(1z2$%x)l&slu'
...
WSGI_APPLICATION = 'teffwebsite.wsgi.application'
